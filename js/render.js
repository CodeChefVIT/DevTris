...
function renderBeginningText() {
	...
	renderText((trueCanvas.width) / 2 + 2 * settings.scale, upperheight - 0 * settings.scale, fontSize, '#3351FF', input_text);
	renderText((trueCanvas.width) / 2 + 2 * settings.scale, upperheight + 33 * settings.scale, fontSize, '#3351FF', action_text);

	renderText((trueCanvas.width) / 2 + 2 * settings.scale, lowerheight, fontSize, '#3351FF', score_text);
}
